...
<div class="row page-title">
    <div class="col-sm-8 col-xl-6">
        <h4 class="mb-1 mt-0">
            Công ty System Architect
            
        </h4>
    </div>
    <div class="col-sm-4 col-xl-6 text-sm-right">
        <div class="btn-group ml-2 d-none d-sm-inline-block">
            <a href="/admin/company/edit" class="btn btn-soft-primary btn-sm"><i class="uil uil-edit mr-1"></i>Sửa</a>
        </div>
...
<div class="row">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                <h6 class="mt-0 header-title">Giới thiệu công ty</h6>
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center mt-3">
                    ...
                    <h5 class="mt-2 mb-2">Công ty System Architect</h5>
