            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-projects" role="tabpanel" aria-labelledby="pills-projects-tab">
                        ...
                        <div class="row mt-3">
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 1, 'status'
                                => 'Finished','category'
                            ...
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 2, 'status'
                                =>
                            ...
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 3, 'status'
                                =>
                            ...
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 4, 'status'
                                =>
                            ...
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 5, 'status'
                                =>
                            ...
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 6, 'status'
                                =>
                            ...
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 7, 'status'
                                =>
                            ...
                            <div class='col-xl-4 col-lg-6'>@component('admin.apps.project.project-item', ['id' => 8, 'status'
                                =>
                    ...
                    <div class="tab-pane fade" id="pills-tasks" role="tabpanel" aria-labelledby="pills-tasks-tab">
                        ...
                        <div class="card mb-0 shadow-none">
                            <div class="card-body">
                                @component('admin.apps.task.task-item', ['id' => 1, 'title' => 'Draft the new
                                ...
                                @component('admin.apps.task.task-item', ['id' => 2, 'title' => 'iOS App home
                                ...
                                @component('admin.apps.task.task-item', ['id' => 3, 'title' => 'Write a release
                                ...
                                @component('admin.apps.task.task-item', ['id' => 4, 'title' => 'Invite user to
                                ...
                                @component('admin.apps.task.task-item', ['id' => 5, 'title' => 'Enable
                                ...
                                @component('admin.apps.task.task-item', ['id' => 6, 'title' => 'Code HTML
                                ...
                                @component('admin.apps.task.task-item', ['id' => 7, 'title' => 'Coordinate
                                with business development', 'assignedTo' => 'Arya Stark','dueDate' =>
                                'No Due Date', 'noChecklists' => 3, 'noComments' => 2,'priority' =>
                                'High', 'assigneeAvatar' =>
                                '/assets/images/users/avatar-9.jpg'])@endcomponent

                                @component('admin.apps.task.task-item', ['id' => 8, 'title' => 'Kanban board
                                design', 'assignedTo' => 'James B','dueDate' => '30 Aug 10am',
                                'noChecklists' => 3, 'noComments' => 2,'priority' => 'Low',
                                'assigneeAvatar' => '/assets/images/users/avatar-5.jpg'])@endcomponent

                                @component('admin.apps.task.task-item', ['id' => 9, 'title' => 'Draft the new
                                ...
                                @component('admin.apps.task.task-item', ['id' => 10, 'title' => 'Draft the new
