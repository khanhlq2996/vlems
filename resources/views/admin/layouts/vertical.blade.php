...
<head>
    ...
    <title>Vietnam Labour Export Management Software - Admin & Dashboard Template</title>
    ...
    @if(isset($isDark) && $isDark)
        @include('admin.layouts.shared.head', ['isDark' => true])
    @elseif(isset($isRTL) && $isRTL)
        @include('admin.layouts.shared.head', ['isRTL' => true])
    @else
...
@endif
    ...
    <script id="__bs_script__">//<![CDATA[
        document.write("<script async src='{{ URL::asset('browser-sync/browser-sync-client.js?v=2.26.7') }}'><\/script>".replace("HOST", location.hostname));
    //]]></script>
    @endif
</body>
