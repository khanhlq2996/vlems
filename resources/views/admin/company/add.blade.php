    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb" class="float-right mt-1">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Thêm mới công ty</li>
            </ol>
        </nav>
        <h4 class="mb-1 mt-0">Thêm Công ty mới</h4>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mt-0">Nhập thông tin Công ty</h4>
                <form class="form-horizontal">
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="simpleinput">Tên Công ty</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="example-number">Mã số thuế</label>
                                <div class="col-lg-8">
                                    <input class="form-control" id="example-number" type="number" name="number" placeholder="Mã số thuế">
                                </div>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="example-textarea">Giới thiệu về Công ty</label>
                                <div class="col-lg-8">
                                    <div id="summernote-editor"></div> 
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary float-right">Lưu Công ty</button>
                        </div>
                    </div>
                </form>
