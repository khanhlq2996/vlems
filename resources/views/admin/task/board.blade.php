        ...
        <div class="board">
            <div class="tasks border">
                ...
                <div id="task-list-one" class="task-list-items">
                    @component('admin.apps.task.board-task-item', ['id' => 1, 'title' => 'Draft the new
                    ...
                    @component('admin.apps.task.board-task-item', ['id' => 2, 'title' => 'iOS App home
                    ...
                    @component('admin.apps.task.board-task-item', ['id' => 3, 'title' => 'Write a release
            ...
            <div class="tasks border">
                ...
                <div id="task-list-two" class="task-list-items">
                    @component('admin.apps.task.board-task-item', ['id' => 4, 'title' => 'Invite user to
                    ...
                    @component('admin.apps.task.board-task-item', ['id' => 5, 'title' => 'Enable
            ...
            <div class="tasks border">
                ...
                <div id="task-list-three" class="task-list-items">
                    @component('admin.apps.task.board-task-item', ['id' => 6, 'title' => 'Code HTML
                    ...
                    @component('admin.apps.task.board-task-item', ['id' => 7, 'title' => 'Coordinate
            ...
            <div class="tasks border">
                ...
                <div id="task-list-four" class="task-list-items">
                    @component('admin.apps.task.board-task-item', ['id' => 8, 'title' => 'Kanban board
